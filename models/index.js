...
const { item, detailed_transaction, transaction, session, user } = db;
...
detailed_transaction.belongsTo(transaction, { foreignKey: 'transaction_id', targetKey: 'transaction_id' });
detailed_transaction.belongsTo(item, { foreignKey: 'item_id', targetKey: 'item_id' });
